...
public class EsempiFunzionale {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n\n\nSomma positivi imperativa: " + sommaPositiviImperativa(valori));
		System.out.println("Somma positivi dichiarativa: " + sommaPositiviFunzionale(valori));
	}
	...
	public static Integer sommaPositiviImperativa(List<Integer> valori) {
		Integer somma = 0;
		for(Integer i : valori) {
			if(i >= 0)
				somma += i;
	...
	public static Integer sommaPositiviFunzionale(List<Integer> valori) {
